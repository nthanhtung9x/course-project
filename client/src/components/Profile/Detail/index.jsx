...
import { Descriptions, Button, Modal, Form, Input, Select, message, Spin } from 'antd';
    ...
    return (
        <div className="profile__detail">
            ...
            <Descriptions bordered column={{ xxl: 4, xl: 3, lg: 3, md: 3, sm: 2, xs: 1 }}>
                ...
                <Descriptions.Item label="Mật khẩu">{detail.password?.slice(-1).padStart(detail.password.length,'*')}</Descriptions.Item>
