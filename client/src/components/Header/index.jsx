...
import { Select, Input, message, List, Avatar, Spin } from "antd";
import {
  DeleteOutlined,
  MenuOutlined,
  LoadingOutlined,
...
const HeaderComponent = ({
  ...
  useEffect(() => {
    setTimeout(() => {
      if (userLogin.logout && !userLogin.username) {
        setLoading(false);
        return;
      }
    }, 1000);
      ...
      <nav className="nav">
              ...
              <li>
                <div className="user">
                  ...
                  <div className="user__feature">
                    ...
                    <Link to={`/profile/coursesList/${userLogin.id}`}>
                      Khóa học của tôi
                    </Link>
        ...
        >
          <ul className="mobile__list">
            ...
            <li>
              <Link to="/courses" onClick={() => setCollapse(false)}>
                Danh sách khóa học
              </Link>
            </li>
            {userLogin.username ? (
                ...
                <li>
                  <div className="user">
                    ...
                    <div className="user__feature">
                      ...
                      <Link
                        to={`/profile/coursesList/${userLogin.id}`}
                        onClick={() => {
                          setCollapse(false);
                        }}
                      >
              ...
              <>
                <li>
                  <Link to="/signup" onClick={() => setCollapse(false)}>
                    Đăng ký
                  </Link>
                </li>
                <li>
                  <Link to="/signin" onClick={() => setCollapse(false)}>
                    Đăng nhập
                  </Link>
                </li>
              </>
        ...
        <ul>
          <li>
            <Select
              ...
              placeholder="Lập trình Front-End"
